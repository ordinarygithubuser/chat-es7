		...
		value: function exists(name) {
			...
			return regeneratorRuntime.async(function exists$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						context$2$0.next = 2;
						return regeneratorRuntime.awrap(this.call('existsUser', [name]));

					case 2:
						res = context$2$0.sent;
						return context$2$0.abrupt('return', res.rows[0].length > 0);
		...
		value: function create(name, pass) {
			...
			return regeneratorRuntime.async(function create$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						context$2$0.next = 2;
						return regeneratorRuntime.awrap(this.call('createUser', [name, pass]));
		...
		value: function login(name, pass) {
			...
			return regeneratorRuntime.async(function login$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						context$2$0.next = 2;
						return regeneratorRuntime.awrap(this.call('loginUser', [name, pass]));
		...
		value: function logout(userId) {
			...
			return regeneratorRuntime.async(function logout$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						context$2$0.next = 2;
						return regeneratorRuntime.awrap(this.call('logoutUser', [userId]));

					case 2:
						res = context$2$0.sent;
						return context$2$0.abrupt('return', res.rows.affectedRows == 1);
		...
		value: function setStatus(userId, text, online) {
			...
			return regeneratorRuntime.async(function setStatus$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						context$2$0.next = 2;
						return regeneratorRuntime.awrap(this.call('setUserStatus', [userId, text, online]));
		...
		value: function getAll() {
			...
			return regeneratorRuntime.async(function getAll$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						context$2$0.next = 2;
						return regeneratorRuntime.awrap(this.call('getAll'));
